  ...
  return (
    <div>
       <div className='bg-[url("/head.png")] h-[350px] w-full sm:bg-cover hidden md:flex justify-center items-center'>
        <div>
           <h1 className='openSans sm:text-[48px] text-[32px] text-white'>Our Chefs</h1>
       ...
       <h1 className='openSans sm:hidden text-[32px] text-zinc-900 text-center mt-4'>Our Chefs</h1>
      <div className='w-full h-full flex justify-center items-center py-5 sm:py-8 lg:py-20'>
        <div className='grid md:grid-cols-4 grid-cols-2 md:grid-rows-2 gap-1 md:gap-3 xl:gap-6 p-1 sm:p-2 xl:p-0'>
          <div>
          ...
          <div>
            <Image src={'/Chef Card 13.png'} alt='' height={446} width={312}/>
          </div>
          <div>
