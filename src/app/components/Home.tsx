...
export default function Home() {
  return (
    ...
    <div className=" h-full w-full bg-cover bg-[url('/bgHome.png')]">
      <div className="w-full h-full xl:p-0 sm:p-7 p-4">
        <div className="w-full flex justify-center pt-6">
            ...
            <nav className="container mx-auto flex flex-wrap items-center lg:justify-between justify-center pt-4">
              <ul className="lg:flex hidden space-x-6 text-[16px] leading-[24px] inter">
                ...
                <li>
                  <HoverCard>
                    <HoverCardTrigger>
                    <p className="hover:text-primYellow cursor-pointer">Pages</p>
                    </HoverCardTrigger>
         ...
         <main className=" w-full justify-center mt-12 text-white flex items-center">
            <div className="w-full lg:w-[1320px] md:flex-row flex flex-col-reverse lg:gap-7 justify-between">
                ...
                <div className="mt-6 sm:mt-0 ">
                    <Image src={'/home.png'} loading="lazy" alt="" width={878} height={670}/>
                </div>
            </div>
        </main>
      </div>
            ...
            <div className="w-full lg:w-[1320px] md:flex-row flex flex-col-reverse lg:gap-7 justify-between">
                <div className="sm:w-[472px] lg:mt-16 mt-6">
                    ...
                    <ul className="space-y-2 mt-4 text-[14px] sm:text-[12px] lg:text-[16px] inter">
                        <li className="flex items-center gap-2"><AiOutlineCheck/> Lacus nisi, et ac dapibus sit eu velit in consequat.</li>
                        <li className="flex items-center gap-2"><AiOutlineCheck/>Lorem ipsum dolor sit amet consectetur adipisicing elit. dapibus</li>
                        <li className="flex items-center gap-2"><AiOutlineCheck/>Lorem ipsum dolor sit amet consectetur adipisicing elit.</li>
                    </ul>
                ...
                <div className="lg:mt-20 sm:mt-12 flex justify-center sm:justify-normal">
                    <div className="sm:grid grid-cols-1 grid-rows-2 space-y-2 sm:space-y-3">
                        <Image src={'/home1.png'} alt="" width={660} height={330} className=""/>
                        <div className="grid grid-cols-2 grid-rows-1 space-x-2 sm:space-x-3">
                            <Image src={'/home2.png'} alt="" width={322} height={195} className=""/>
                            <Image src={'/home3.png'} alt="" width={322} height={195} className=""/>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div className="h-full w-full">
        ...
        <div className="w-full lg:w-[1320px] flex-col ">
                ...
                <div className="lg:mt-20 mt-8 ">
                        <Image src={'/box.png'} alt="" width={1320} height={330}/>
                </div>
            </div>
        </main> 
    </div>
               ...
               <div className="lg:mt-18 sm:mt-12 md:mt-0 ">
                    <div className="grid grid-cols-2 grid-rows-2 space-y-2 sm:space-y-3 space-x-2 md:space-x-3 w-full">
                      <div className="flex items-end">
                          <Image src={'/img1.png'} alt="" width={362} height={356} className=" sm:mt-0 hover:scale-105 transition-transform duration-200"/>
                      </div>
                      <div className="flex items-end">
                          <Image src={'/img2.png'} alt="" width={281} height={231} className=" hover:scale-105 transition-transform duration-200" />
                      </div>
                      <div className="grid grid-cols-3 col-span-3 md:col-span-2 lg:col-span-3 grid-rows-1 space-x-2 sm:space-x-3">
                        <div>
                          <Image src={'/img3.png'} alt="" width={244} height={306} className="hover:scale-105 transition-transform duration-200"/>            
                        </div>
                        <div>
                          <Image src={'/img4.png'} alt="" width={221} height={226} className="hover:scale-105 transition-transform duration-200"/>
                      
                        </div>
                        <div className="space-y-2 sm:space-y-3 ">
                          <Image src={'/img5.png'} alt="" width={161} height={168} className="hover:scale-105 transition-transform duration-200"/>
                          <Image src={'/img6.png'} alt="" width={161} height={168} className="hover:scale-105 transition-transform duration-200"/>
                        </div>
                        </div>
                    </div>
                </div> 
                ...
                <div className="sm:w-[490px] lg:w-[530px] md:w-full w-full lg:mt-24 mt-6 ">
                    ...
                    <h1 className="text-[28px] md:text-[36px] lg:text-[60px] font-bold leading-snug md:leading-tight text-primYellow openSans">
                        Ex<span className="text-white">tra ordinary taste
                        And Experience </span>
                    </h1>
                    <p className="mt-4 sm:mt-2 lg:mt-4 text-[14px] sm:text-[12px] lg:text-[16px] inter text-white">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam pellentesque bibendum non dui volutpat fringilla bibendum. Urna, elit augue urna, vitae feugiat pretium donec id elementum. Ultrices mattis sed vitae mus risus. Lacus nisi, et ac dapibus sit eu velit in consequat.                    </p>
                    <ul className="flex w-full justify-center lg:justify-start gap-4 lg:gap-8 lg:mt-8 mt-4">
                        <li> 
                          <div className="bg-primYellow flex items-center justify-center lg:py-3 py-1 lg:px-3 px-1 hover:scale-105 transition-transform duration-200"><PiHamburgerThin size={56}/></div>
                          <p className="inter lg:text-[18px] text-[12px] text-white text-center mt-1">Fast Food</p> 
                        </li>
                        <li> 
                          <div className="bg-primYellow flex items-center justify-center lg:py-3 py-1 lg:px-3 px-1 hover:scale-105 transition-transform duration-200"><PiCookieLight size={56}/></div>
                          <p className="inter lg:text-[18px] text-[12px] text-white text-center mt-1">Lunch</p> 
                        </li>
                        <li> 
                          <div className="bg-primYellow flex items-center justify-center lg:py-3 py-1 lg:px-3 px-1 hover:scale-105 transition-transform duration-200"><PiWineLight size={56}/></div>
                          <p className="inter lg:text-[18px] text-[12px] text-white text-center mt-1">Dinner</p> 
                        </li>
                    </ul>
          ...
          <div className="w-full lg:w-[1320px] flex-col p-2 py-9">
              <div className="w-full mt-6 text-center">
                  ...
                  <ul className="md:flex hidden justify-around inter text-[20px] text-white mt-12">
                    <li className="hover:text-primYellow cursor-pointer" >Breakfast</li>
                    <li className="hover:text-primYellow cursor-pointer">Lunch</li>
                    <li className="hover:text-primYellow cursor-pointer">Dinner</li>
                    <li className="hover:text-primYellow cursor-pointer">Dessert</li>
              ...
              <div className="mt-8 flex gap-4 items-center">
                <Image src={'/img7.png'} alt="" width={366} height={366} className="hidden lg:flex"/>
                <ul className="space-y-2">
                  <li><Image src={'/item1.png'} alt="" width={376} height={79}/></li>
                  <li><Image src={'/item2.png'} alt="" width={376} height={79}/></li>
                  <li><Image src={'/item3.png'} alt="" width={376} height={79}/></li>
                </ul>
                <ul className="space-y-2">
                  <li><Image src={'/item4.png'} alt="" width={376} height={79}/></li>
                  <li><Image src={'/item5.png'} alt="" width={376} height={79}/></li>
                  <li><Image src={'/item6.png'} alt="" width={376} height={79}/></li>
                </ul>
        ...
        <div className="w-full lg:w-[1320px] flex-col p-2">
                ...
                <div className="lg:mt-20 sm:mt-12 mt-4">
                    <ul className="space-x-3 w-full flex">
                      <li><Image src={'/chef1.png'} alt="" width={312} height={391}/></li>
                      <li><Image src={'/chef2.png'} alt="" width={312} height={391}/></li>
                      <li><Image src={'/chef3.png'} alt="" width={312} height={391} className=""/></li>
                      <li><Image src={'/chef4.png'} alt="" width={312} height={391} className="sm:flex hidden"/></li>
                    </ul>              
                </div>
                <div className="flex justify-center mt-10">
                  <button className="inter sm:text-[16px] text-[10px] sm:px-5 px-3 sm:py-2 py-1 border-[1px] rounded-full border-primYellow hover:bg-primYellow hover:text-black transition-colors duration-200">See More</button>
                </div>
            </div>
        </main> 
    </div>
    ...
    <div className="bg-black">
      <Image src={'/box3.png'} alt="" width={1920} height={560} className="sm:py-12 py-4"/>
    </div>
    <div className="h-full w-full">
        <main className="bg-black w-full justify-center text-white flex items-center p-3 lg:p-6 xl:p-0">
            <div className="w-full lg:w-[1320px] flex-col p-2 sm:py-12">
                ...
                <div className=" sm:mt-12 mt-4">
                    <ul className="space-x-5 w-full flex">
                      <li><Image src={'/BlogCard1.png'} alt="" width={424} height={569}/></li>
                      <li><Image src={'/BlogCard2.png'} alt="" width={424} height={569}/></li>
                      <li><Image src={'/BlogCard3.png'} alt="" width={424} height={569} className=""/></li>
                    </ul>              
                </div>
            </div>
        </main> 
